...
const autoInsert = __importStar(require("./languageFeatures/autoInsert"));
const callHierarchy = __importStar(require("./languageFeatures/callHierarchy"));
const codeActionResolve = __importStar(require("./languageFeatures/codeActionResolve"));
const codeActions = __importStar(require("./languageFeatures/codeActions"));
const codeLens = __importStar(require("./languageFeatures/codeLens"));
const codeLensResolve = __importStar(require("./languageFeatures/codeLensResolve"));
const completions = __importStar(require("./languageFeatures/complete"));
const completionResolve = __importStar(require("./languageFeatures/completeResolve"));
const definition = __importStar(require("./languageFeatures/definition"));
const documentHighlight = __importStar(require("./languageFeatures/documentHighlights"));
const documentLink = __importStar(require("./languageFeatures/documentLinks"));
const documentLinkResolve = __importStar(require("./languageFeatures/documentLinkResolve"));
const semanticTokens = __importStar(require("./languageFeatures/documentSemanticTokens"));
const fileReferences = __importStar(require("./languageFeatures/fileReferences"));
const fileRename = __importStar(require("./languageFeatures/fileRename"));
const hover = __importStar(require("./languageFeatures/hover"));
const inlayHints = __importStar(require("./languageFeatures/inlayHints"));
const inlayHintResolve = __importStar(require("./languageFeatures/inlayHintResolve"));
const references = __importStar(require("./languageFeatures/references"));
const rename = __importStar(require("./languageFeatures/rename"));
const renamePrepare = __importStar(require("./languageFeatures/renamePrepare"));
const signatureHelp = __importStar(require("./languageFeatures/signatureHelp"));
const diagnostics = __importStar(require("./languageFeatures/validation"));
const workspaceSymbol = __importStar(require("./languageFeatures/workspaceSymbols"));
const colorPresentations = __importStar(require("./documentFeatures/colorPresentations"));
const documentColors = __importStar(require("./documentFeatures/documentColors"));
const documentSymbols = __importStar(require("./documentFeatures/documentSymbols"));
const foldingRanges = __importStar(require("./documentFeatures/foldingRanges"));
const format = __importStar(require("./documentFeatures/format"));
const linkedEditingRanges = __importStar(require("./documentFeatures/linkedEditingRanges"));
const selectionRanges = __importStar(require("./documentFeatures/selectionRanges"));
