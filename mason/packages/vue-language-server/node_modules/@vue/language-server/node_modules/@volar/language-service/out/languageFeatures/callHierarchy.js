...
function register(context) {
    ...
    function transformCallHierarchyItem(tsItem, tsRanges) {
        ...
        for (const [_, map] of context.documents.getMapsByVirtualFileUri(tsItem.uri)) {
            ...
            const vueItem = {
                ...tsItem,
                name: tsItem.name === path_1.posix.basename(context.env.uriToFileName(map.virtualFileDocument.uri)) ? path_1.posix.basename(context.env.uriToFileName(map.sourceFileDocument.uri)) : tsItem.name,
