...
_G.packer_plugins = {
  ...
  ["autoclose.nvim"] = {
    loaded = true,
    path = "/home/e/.local/share/nvim/site/pack/packer/start/autoclose.nvim",
...
try_loadstring("\27LJ\2\n+\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\16config.tags\frequire\0", "config", "trailblazer.nvim")
